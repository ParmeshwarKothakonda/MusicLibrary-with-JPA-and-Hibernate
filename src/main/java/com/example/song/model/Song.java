...
public class Song{
    ...
    public String getSongName(){ //getter
        return songName;
    }
    ...
    public String getLyricist(){ //getter
        return lyricist;
    }
    ...
    public String getSinger(){ //getter
        return singer;
    }
    ...
    public String getMusicDirector(){ //getter
